      ...
      <div className="container">
        <div className="py-10 px-5">
          <div className="flex flex-col space-y-2">
            <p>
              This privacy notice for Ion Tofan Versicherungsvertreter
            ...
            <h2 className="text-md font-semibold">SUMMARY OF KEY POINTS</h2>
            <p>
            ...
            <p>
              ...
              depending on how you interact with Ion Tofan
              Versicherungsvertreter and the Services, the choices you make, and
            ...
            <p>
              Want to learn more about what Ion Tofan Versicherungsvertreter
              does with any information we collect?
            </p>
            <h2 className="text-md font-semibold">TABLE OF CONTENTS</h2>
            <ul>
            ...
            <ul>
              <li className="font-bold">names</li>
              <li className="font-bold">phone numbers</li>
              <li className="font-bold">email addresses</li>
            ...
            <p>
              ...
              facilitate account creation and authentication and otherwise
              ...
              working order. To save or protect an individual's vital interest.
            ...
            <p>
              n Short: We only process your personal information when we believe
            ...
            <p>
              ...
              You can withdraw your consent at any time. Legal Obligations. We
              ...
              litigation in which we are involved. Vital Interests. We may
            ...
            <ul>
              <li className="font-bold">Ion Tofan Versicherungsvertreter</li>
              <li className="font-bold">Luitgardstrasse 14-18</li>
              <li className="font-bold">Pforzheim, Baden-Württemberg 75177</li>
            ...
            <p>
              ...
              a request form by clicking here. This privacy policy was created
