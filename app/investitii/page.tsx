...
export default function InvestitiiPage() {
  const dir = path.join(process.cwd(), "posts/investitii");
      ...
      <div className="mx-auto max-w-[1280px] px-4">
        ...
        <div className="text-center mb-12">
          <p className="text-[#C6912B] text-sm font-semibold tracking-wide uppercase pb-3">
            Investițiile tale, viitorul tău sigur
          </p>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-roboto text-[#0C3559]">
            Soluții financiare adaptate pentru tine și planurile tale de viitor
          </h1>
        </div>
